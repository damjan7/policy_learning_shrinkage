...
print("done and save")
path = r"H:\all\RL_Shrinkage_2024\ONE_YR_long_only\preprocessing\QIS_shrinkages.csv"
QIS_shrkges_df = pd.DataFrame(QIS_shrkges)
QIS_shrkges_df.to_csv(path, index=False)

# save version 2
path1 = r"H:\all\RL_Shrinkage_2024\ONE_YR_long_only\preprocessing\QIS_deltas.csv"
path2 = r"H:\all\RL_Shrinkage_2024\ONE_YR_long_only\preprocessing\sample_eigenvalues.csv"
